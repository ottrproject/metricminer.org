...
- `See, edit, create, and delete all your Google Sheets spreadsheets. Learn more` This is used for accessing sheets made with [Slido](https://hutchdatascience.org/metricminer/articles/getting-started.html#slido) as well as for writing data to Google Sheets if you so choose.
