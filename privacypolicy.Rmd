...
- `See all responses to your Google Forms forms.` - This is used for when you'd like to retrieve Google Form response data that are stored in your Google Drive. [Functions that use this scope](https://hutchdatascience.org/metricminer/#google-forms)
